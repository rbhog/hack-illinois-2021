...
var newURL = "http://172.16.99.94:5000/";
document.getElementById("day").innerHTML = "Date: ".concat(wantedDate.getMonth() + 1 + "/" + wantedDate.getDate() + "/" + wantedDate.getFullYear()); // const picker = datepicker("#simple", {
...
map.on("load", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
  var geojson, updateSource, getData, _getData;
      ...
      switch (_context3.prev = _context3.next) {
        case 0:
          _getData = function _getData3() {
            _getData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(updateSource) {
              var response, res;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                      ...
                      res = response.json(); // Return the location of the ISS as GeoJSON.
        ...
        case 5:
          ...
          updateSource = setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var geojson;
          ...
          document.getElementById("slider").addEventListener("input", function (e) {
            ...
            document.getElementById("day").innerHTML = "Date: ".concat(wantedDate.getMonth() + 1 + "/" + wantedDate.getDate() + "/" + wantedDate.getFullYear());
          });
